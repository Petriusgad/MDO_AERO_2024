...
class Monoplano:
    ...
    def __init__(self, asa, perfil_asa, iw, eh, perfil_eh, ih, ev, perfil_ev, posicoes, tipo_ev = 'u', tipo_helice = '16x8'):
        ...
        #print(self.pos_eh)
        self.envergadura = self.geometria_asa[5][0]*2
        self.dist_solo_ev = self.dist_ev_solo()
        self.atualizar_geometria()
        self.xcg = self.cw*4/3
        ...
        self.ME = (self.Xnp - self.xcg)/self.cw*4
    ...
    def atualizar_geometria(self):
        ...
        self.lh = self.posicoes["eh"][0] - 0.25*(4*self.cw - self.ch)
        self.lv = self.posicoes["ev"][0] - 0.25*(4*self.cw - self.cv)
        self.VH = (self.lh*self.Sh)/(4*self.cw*self.Sw)
    ...
    def avaliar(self):
        ...
        res += 20*func_erro(self.VH, 0.35, 0.5)
        res += 20*func_erro(self.VV, 0.04, 0.06)
        self.nota = res
