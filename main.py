...
optimizer.perfil_asa = sys.argv[1]
optimizer.perfil_eh = sys.argv[2]
print(optimizer.perfil_asa, optimizer.perfil_eh)
#P_asa = sys.argv[1]
#P_eh = sys.argv[2]
#print(P_asa, P_eh)

code = optimizer.perfil_asa + '-' + optimizer.perfil_eh + '-' + str(random.randint(100, 999))
...
gerações_df.to_excel(r'C:/Users/Petrius/Desktop/Aeromec/avl/config/'+code+'.xlsx', index=False)
